...
if __name__ == "__main__":
    # Input Excel file
    input_excel_file = r"C:\Users\ShashidharReddyMaram\Downloads\PNew.xlsx"  # replace with your input file name
    output_folder = r"C:\Users\ShashidharReddyMaram\Downloads"

    # List of values to search for in the first column
    search_list = ['AmazonS3', 'AmazonVPC', 'AWSDirectConnect', 'AWSQueueService', 'AWSLambda']  # replace with your list values
